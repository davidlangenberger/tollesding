...
export const products: Product[] = [
  ...
  {
    id: "usb-ladegeraet",
    title: "USB-Ladeplatz mit kurzen Kabeln",
    shortBenefit:
      "Dieses Setup aus USB-Mehrfachladegerät und kurzen Ladekabeln sorgt bei uns für einen festen, aufgeräumten Ladeplatz für praktisch alles, was sonst lose herumfliegt. Statt Netzteile in verschiedenen Zimmern, langen Kabeln und ständigem Suchen steht alles an einem Ort, auf den jeder direkt zugreifen kann.",
    storyTeaser:
      "Genau das ist bei uns der große Vorteil: Das Ladegerät steht an einem festen Platz und daran hängen die kurzen Kabel, die wir wirklich brauchen. Lightning für ein älteres iPhone, USB-C für die Tablets der Kinder, Micro-USB fürs E-Book und dazu noch weitere Kabel für Uhr oder andere Geräte. Dadurch muss niemand mehr erst Ladegeräte zusammensuchen oder Kabel entwirren. Gerade mit den sehr kurzen Kabeln bleibt alles deutlich ordentlicher und alltagstauglicher. Für uns ist das eine dieser unspektakulären Lösungen, die den Haushalt spürbar aufräumen.",
    imageAlt:
      "USB-Mehrfachladegerät mit mehreren USB-A- und USB-C-Anschlüssen als zentrale Ladestation im Familienalltag",
    category: "Technik",
    tags: ["Technik", "Ordnung", "Ladestation", "Kabel"],
    amazonUrl: "https://www.amazon.de/dp/B0D7MTHGS2",
    amazonLinks: [
      {
        label: "Ladegerät bei Amazon ansehen",
        url: "https://www.amazon.de/dp/B0D7MTHGS2"
      },
      {
        label: "Kurze Kabel bei Amazon ansehen",
        url: "https://www.amazon.de/dp/B0DL9MKRKT"
      }
    ],
